...
CREATE TABLE TelemetryEvents(Id INTEGER PRIMARY KEY AUTO_INCREMENT, TelemetryId INTEGER NOT NULL, Value REAL NOT NULL, Date TIMESTAMP NOT NULL, FOREIGN KEY(TelemetryId) REFERENCES Telemetries(Id) ON DELETE CASCADE);
