...
CREATE TABLE ElevantionRect(Id INTEGER PRIMARY KEY AUTO_INCREMENT, Height INTEGER NOT NULL, NWLongitude REAL NOT NULL, NWLatitude REAL NOT NULL, SELongitude REAL NOT NULL, SELatitude REAL NOT NULL);
