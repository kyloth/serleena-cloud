...
CREATE TABLE ExperienceUserPoints(Id INTEGER PRIMARY KEY AUTO_INCREMENT, ExperienceId VARCHAR(36) NOT NULL, Longitude REAL NOT NULL, Latitude REAL NOT NULL, FOREIGN KEY(ExperienceId) REFERENCES Experiences(Id));
